    ...
    return (
      <div>
        <ListGroup
          className="mt-4 menu"
          variant="flush"
          onClick={this.onListGroupClick}
        >
          {getName === "React" ? (
            <ListGroupItem
              id="react"
              className="justify-content-between active"
            >
              React{" "}
            </ListGroupItem>
          ) : (
            <ListGroupItem id="react" className="justify-content-between">
              React{" "}
            </ListGroupItem>
          )}
          {getName === "NodeJS" ? (
            ...
            <ListGroupItem id="nodejs" className="justify-content-between">
              NodeJS{" "}
            </ListGroupItem>
          )}
          {getName === "React Native" ? (
            ...
            <ListGroupItem id="reactnat" className="justify-content-between">
              React Native
            </ListGroupItem>
          )}
        </ListGroup>
